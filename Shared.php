    <head>
        ...
        <link rel="stylesheet" href="Assets/StyleShared.css">
        <link href="Assets/index2.php">
    </head>

    <body>

        <img src="logo.jpeg" alt="Logo.jpeg" style="position:absolute; top:2%; left:2%;">

        <form id="boxy" style="text-align: center;" class="boxy" method="POST" enctype="multipart/form-data" action="upload.php">
            <div id="ImgContainer">
              <p1 class="box"><img src="Assets/NoImageFoundIcon.png" width="250" height="250"><br>
              No Files Found</p1>
            </div>  
            ...
            for ($a = 2; $a < count($files); $a++) {
              ...
              //Making it downloadable
                ?>
                <p>
                <a  download="<?php echo $files[$a] ?>" href="Uploads/<?php echo $files[$a] ?>" class="PDF" id="PDF"><?php echo $files[$a] ?></a>
                </p>
              <?php
            }
            ?>

            <input type="file" name="file" style="display: inline-block; position: absolute; left: -0.5%; top: 105%;" class="AddButton">
            <input type="submit" value="Upload" style="display: inline-block; position: absolute; right: -0.5%; top: 105%;" class="UploadButton">
        </form> 
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function () {
          ...
          var links = document.querySelectorAll(".PDF");
